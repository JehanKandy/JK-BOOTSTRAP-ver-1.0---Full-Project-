        ...
        <div class="login-box">
            ...
            <?php 
                ...
                if(isset($_POST['email'])){
                    $result = pass_email($_POST['pass_email']);
                    echo $result;
                }
            ?>
                <form action="<?php echo($_SERVER['PHP_SELF']); ?>" method="POST">
                    <p>Enter Email : </p>
                    <input type="email" name="pass_email" placeholder="OTP" class="login-input" required>
                    <br><br>
                    <input type="submit" value="Submit" name="email" class="login-btn">
                </form>
